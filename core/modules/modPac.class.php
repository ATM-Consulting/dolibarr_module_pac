...
/**
 * 	\defgroup   pac     Module Pac
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/pac/core/modules directory.
 *  \file       htdocs/pac/core/modules/modPac.class.php
 *  \ingroup    pac
 *  \brief      Description and activation file for module Pac
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Pac
 */
class modPac extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104004; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'pac';
		...
		// for default path (eg: /pac/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /pac/core/modules/barcode)
		// for specific css file (eg: /pac/css/pac.css.php)
		...
		//							'css' => array('/pac/css/pac.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/pac/js/pac.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		// Config pages. Put here list of php page, stored into pac/admin directory, to use to setup module.
		$this->config_page_url = array("pac_setup.php@pac");
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@pac:$user->rights->pac->read:/pac/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:mylangfile@pac:$user->rights->othermodule->read:/pac/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->pac->enabled,$conf->pac->enabled,$conf->pac->enabled)												// Condition to show each dictionary
        );
        */
		...
		//							'leftmenu'=>'pac',
		//							'url'=>'/pac/pagetop.php',
		//							'langs'=>'mylangfile@pac',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->pac->enabled',	// Define condition to show or hide menu entry. Use '$conf->pac->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=commercial',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		 ...
		 $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=commercial,fk_leftmenu=pac',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
									'type'=>'left',			                // This is a Left menu entry
									'titre'=>$langs->transnoentitiesnoconv('propalCommercial'),
									'mainmenu'=>'',
									'leftmenu'=>'',
									'url'=>'/pac/graph_propal_commercial.php',
									'langs'=>'pac@pac',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>120,
									'enabled'=>'$conf->pac->enabled',  // Define condition to show or hide menu entry. Use '$conf->pac->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
									'perms'=>'1',			                // Use 'perms'=>'$user->rights->pac->level1->level2' if you want your menu with a permission rules
